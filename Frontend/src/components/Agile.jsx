    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* First Image */}
                <img
                    src="/src/assets/agile.jpeg" // Replace with the actual path of the image
                    alt="Agile Solutions"
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Agile Frameworks for Startups to Enhance Productivity and Adaptability</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Implement agile methodologies for quicker project delivery.</li>
                        <li>Enhance collaboration and communication within teams.</li>
                        <li>Adapt to changing requirements and market dynamics effectively.</li>
                        <li>Foster a culture of continuous improvement and learning.</li>
                        <li>Maximize productivity through iterative development cycles.</li>
                    </ul>
                </div>
            </div>
