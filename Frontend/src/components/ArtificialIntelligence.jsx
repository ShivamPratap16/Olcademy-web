...
const aiData = [
    {
        ...
        subtitle: "Revolutionizing patient care and diagnostics with AI technologies.",
        image: services1,
        link: "/ai-healthcare",
    },
    {
        title: "AI in Finance",
        subtitle: "Optimizing financial operations with AI-driven automation and analytics.",
        image: services2,
        link: "/ai-finance",
    },
    {
        title: "AI for Smart Cities",
        subtitle: "Building intelligent urban environments with AI-powered solutions.",
        image: services3,
        link: "/ai-smart-cities",
    },
    {
        title: "AI for Retail",
        subtitle: "Enhancing customer experience and operations in retail with AI tools.",
        image: services5,
        link: "/ai-retail",
    },
];
    ...
    return (
        <div className="w-full h-auto bg-white">
            ...
            <div className="relative h-[85vh] mt-16 image-container">
                <img
                    src="/src/assets/a.jpg"// Adjusted image path
                    alt="AI"
                    className="absolute inset-0 object-cover w-full h-full"
                />
                <div className="absolute inset-0 bg-black opacity-30"></div>
                <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
                    <h2 className="text-sm font-semibold text-white uppercase tracking-widest mb-2">Industries / AI</h2>
                    <h1 className="text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
                        Artificial Intelligence
                    </h1>
                    <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
                        Revolutionizing industries with intelligent automation, insights, and decision-making.
                    </p>
                </div>
            </div>

            {/* New Information Section - AI Innovation */}
            <div className="flex flex-col items-center justify-center h-[80vh] bg-white">
                <div className="max-w-3xl text-center">
                    ...
                    <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                        Artificial Intelligence is no longer a futuristic concept, but a present-day reality. From automation to data analysis, AI is transforming industries by providing unprecedented opportunities for innovation and efficiency. Discover how AI can drive your business forward.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-gray-900 mt-8 bg-white rounded-lg shadow-lg">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
                    <h2 className="text-4xl mb-4 text-black">
                        Partner with us for cutting-edge AI solutions.
                    </h2>
