    ...
    return (
        <div className="w-full h-auto bg-white">
            ...
            <div className="relative h-[85vh] mt-16 image-container">
                <img src="/src/assets/bank.jpg" alt="Banking" className="absolute inset-0 object-cover w-full h-full" />
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
                    ...
                    <h1 className="text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">Banking</h1>
            ...
            <div className="flex flex-col items-center justify-center h-[80vh] bg-white">
                <div className="max-w-3xl text-center">
                    <h2 className="text-4xl mb-4 text-gray-800 font-semibold">Banking Innovation</h2>
                    <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                        The banking sector is evolving beyond conventional boundaries, with financial services increasingly integrated into diverse industry ecosystems.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-gray-900 mt-8 bg-white rounded-lg shadow-lg">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
                    <h2 className="text-4xl mb-4 text-black">Partner with us for intelligent banking solutions.</h2>
                    <h3 className="text-sm font-bold uppercase mb-2 text-gray-500">Your Challenge</h3>
                    <div className="space-y-4">
                        {solutionData.map((item, index) => (
                            <div key={index} className={`flex items-center p-4 rounded-lg border transition-all duration-300 ${selectedChallenge === index ? "bg-blue-100 border-[#15a7e7]" : "bg-gray-50 border-gray-300"}`}>
                                <button className={`text-lg font-bold rounded-full w-10 h-10 flex items-center justify-center transition-all duration-300 ${selectedChallenge === index ? "bg-[#15a7e7] text-white" : "bg-gray-300 text-black"}`} onClick={() => handleClick(index)}>
                                    {index + 1}
                                </button>
                                <div className="ml-4">
                                    <h4 className="text-lg font-semibold cursor-pointer" onClick={() => handleClick(index)}>
                                        {item.solutionTitle}
                                    </h4>
                                </div>
                            </div>
