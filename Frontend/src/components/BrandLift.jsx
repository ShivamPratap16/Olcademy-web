    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* First Image */}
                <img
                    src="/src/assets/brand.png" // Replace with the actual path of the image
                    alt="BrandLift Solutions"
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Helping Startups Establish and Elevate Their Brand Presence</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Develop a strong brand identity that resonates with your audience.</li>
                        <li>Leverage marketing strategies to increase brand visibility.</li>
                        <li>Utilize social media and digital platforms for brand promotion.</li>
                        <li>Conduct market research to understand consumer perceptions.</li>
                        <li>Create engaging content to foster brand loyalty and trust.</li>
                    </ul>
                </div>
            </div>
