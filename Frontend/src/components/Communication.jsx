...
const data = [
    {
        ...
        subtitle: "Seamless integration of communication channels for improved collaboration.",
        image: services1,
        link: "/unified-communications",
    },
    {
        title: "5G and Beyond",
        subtitle: "Transforming connectivity with ultra-fast speeds and low latency.",
        image: services2,
        link: "/5g-and-beyond",
    },
    {
        title: "Digital Media Solutions",
        subtitle: "Enhancing engagement through immersive digital experiences.",
        image: services3,
        link: "/digital-media-solutions",
    },
    {
        title: "Network Security",
        subtitle: "Ensuring secure, reliable communication infrastructures.",
        image: services5,
...
const Communication = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Enhancing Digital Connectivity",
            solutionContent:
                "We deliver innovative solutions that strengthen connectivity across various devices and networks, improving communication reliability and speed.",
        },
        {
            solutionTitle: "Enabling Smart Collaboration",
            solutionContent:
                "Our smart collaboration tools utilize cloud and AI to offer seamless communication experiences, enabling remote teams to work efficiently.",
        },
        {
            solutionTitle: "Securing Communication Channels",
            solutionContent:
                "With robust security protocols, we protect sensitive information across channels, ensuring data integrity and privacy.",
        },
        {
            solutionTitle: "Optimizing Network Efficiency",
            solutionContent:
        ...
        <div className="w-full h-auto bg-white">
            ...
            <div className="relative h-[85vh] mt-16 image-container">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
                    <h2 className="text-sm font-semibold text-white uppercase tracking-widest mb-2">Industries / Communication</h2>
                    <h1 className="text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
                        Communication
                    </h1>
                    <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
                        Driving digital transformation in communication networks worldwide.
                    </p>
                </div>
            </div>

            {/* New Information Section - Innovation in Communication */}
    ...
    <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-black leading-relaxed">
            The communication sector is rapidly evolving, with cutting-edge solutions enabling real-time connectivity across the globe. We provide strategies to help organizations deliver exceptional communication experiences.
        </p>
    </div>
</div>
