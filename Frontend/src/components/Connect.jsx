    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* Background Image */}
                <img
                    src="/src/assets/connect.jpg" // Ensure this image exists in your assets
                    alt="Olcademy Connect"
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Building Networks for Growth</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Facilitating connections with industry leaders and experts.</li>
                        <li>Providing access to exclusive networking events and workshops.</li>
                        <li>Creating collaborative opportunities for shared growth.</li>
                        <li>Leveraging technology to enhance communication and collaboration.</li>
                        <li>Fostering a supportive community for continuous learning and development.</li>
                    </ul>
                </div>
            </div>
