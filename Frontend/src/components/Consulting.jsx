        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Elevate Your Business with Expert Consulting</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Receive tailored strategies to meet your unique business needs.</li>
                        <li>Enhance operational efficiency through expert guidance.</li>
                        <li>Leverage industry insights to stay ahead of market trends.</li>
                        <li>Foster innovation and adaptability within your organization.</li>
                        <li>Implement best practices to drive sustainable growth.</li>
                    </ul>
                </div>
            </div>
