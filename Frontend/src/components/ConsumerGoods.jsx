...
const data = [
    {
        ...
        subtitle: "Optimizing logistics for enhanced product delivery.",
        image: services1,
        link: "/supply-chain-management",
    },
    {
        title: "Consumer Insights",
        subtitle: "Harnessing data analytics for better customer understanding.",
        image: services2,
        link: "/consumer-insights",
    },
    {
        title: "Product Innovation",
        subtitle: "Driving innovation in product development and marketing.",
        image: services3,
        link: "/product-innovation",
    },
    {
        title: "Sustainability Practices",
        subtitle: "Implementing eco-friendly practices in operations.",
        image: services5,
...
const ConsumerGoods = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Enhancing customer engagement",
            solutionContent:
                "Our strategies focus on personalized customer experiences, using data-driven insights to enhance engagement and satisfaction. By understanding consumer preferences, we help brands build lasting relationships with their customers.",
        },
        {
            solutionTitle: "Streamlining operations",
            solutionContent:
                "We provide solutions that optimize operational workflows, reducing inefficiencies and improving responsiveness to market demands. Our approach integrates technology and data analytics for better decision-making.",
        },
        {
            solutionTitle: "Driving sustainable practices",
            solutionContent:
                "With a focus on sustainability, we assist brands in adopting environmentally friendly practices, from sourcing to production. Our solutions promote corporate responsibility while appealing to eco-conscious consumers.",
        },
        {
            solutionTitle: "Leveraging digital transformation",
            solutionContent:
                "Through digital technologies, we help brands enhance their online presence and improve customer interactions. Our solutions support e-commerce growth and effective digital marketing strategies.",
        },
    ];
    ...
    return (
        <div className="w-full h-auto bg-white">
            ...
            <div className="relative h-[85vh] mt-16 image-container">
                <img
                    src="/src/assets/consumer.jpg"
                    alt="Consumer Goods"
                    className="absolute inset-0 object-cover w-full h-full"
                />
                <div className="absolute inset-0 bg-black opacity-30"></div>
                <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
                    <h2 className="text-sm font-semibold text-white uppercase tracking-widest mb-2">Industries / Consumer Goods</h2>
                    <h1 className="text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
                        Consumer Goods
                    </h1>
                    <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
                        Olcademy empowers brands in the consumer goods sector to innovate and grow.
                    </p>
                </div>
            </div>

            {/* New Information Section - Consumer Goods Innovation */}
    ...
    <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-black mb-4 leading-relaxed">
            The consumer goods industry is rapidly evolving, with brands increasingly adapting to consumer preferences and market dynamics. We help organizations leverage innovative strategies to deliver exceptional value and engage consumers effectively.
        </p>
    </div>
</div>
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-gray-900 mt-8 bg-white rounded-lg shadow-lg">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
                    <h2 className="text-4xl mb-4 text-black">
                        Partner with us for intelligent consumer goods solutions.
                    </h2>
