        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Unlock Insights with Data and Analytics</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Transform raw data into actionable insights for better decision-making.</li>
                        <li>Leverage advanced analytics tools to optimize business operations.</li>
                        <li>Enhance customer experience through personalized data-driven strategies.</li>
                        <li>Monitor key performance indicators to gauge business success.</li>
                        <li>Utilize predictive analytics to anticipate future trends and challenges.</li>
                    </ul>
                </div>
            </div>
