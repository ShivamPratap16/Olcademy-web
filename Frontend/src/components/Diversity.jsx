        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Building an Inclusive Future with Olcademy</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Champion diversity in all forms across teams and projects.</li>
                        <li>Create equitable opportunities for growth and advancement.</li>
                        <li>Foster a culture of inclusion and belonging for all employees.</li>
                        <li>Promote a work environment free from bias and discrimination.</li>
                        <li>Encourage diverse perspectives and experiences in decision-making.</li>
                    </ul>
                </div>
            </div>
