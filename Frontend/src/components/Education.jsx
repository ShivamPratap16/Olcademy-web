...
const Education = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Enhancing Student Engagement",
            solutionContent:
                "We provide solutions that captivate students and enhance participation through interactive tools and resources.",
        },
        {
            solutionTitle: "Streamlining Administrative Processes",
            solutionContent:
                "Our services help educational institutions optimize their operations, ensuring efficient management and communication.",
        },
        {
            solutionTitle: "Integrating Advanced Learning Technologies",
            solutionContent:
                "We facilitate the adoption of new technologies, improving learning outcomes and accessibility.",
        },
        {
            solutionTitle: "Supporting Remote Learning",
            solutionContent:
                "With robust platforms, we empower students and educators to maintain continuity in education, regardless of location.",
        },
    ];
    ...
    return (
        <div className="w-full h-auto bg-white">
            ...
            <div className="relative h-[85vh] mt-16 image-container">
                <img
                    src="/src/assets/edu.jpg" // Update hero image path
                    alt="Education"
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
                    ...
                    <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
                        Empowering learners and educators through innovative solutions.
                    </p>
                </div>
            </div>

            {/* New Information Section - Innovation in Education */}
    ...
    <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-black mb-4 leading-relaxed">
            The education sector is rapidly evolving, with innovative solutions transforming the way we teach and learn. We help organizations deliver exceptional educational experiences.
        </p>
    </div>
</div>
