        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Streamline Operations with Enterprise Solutions</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Enhance collaboration across teams with integrated software solutions.</li>
                        <li>Optimize workflows and increase productivity through automation.</li>
                        <li>Improve data management and accessibility for informed decision-making.</li>
                        <li>Customize solutions to meet the unique needs of your business.</li>
                        <li>Scale your operations seamlessly as your business grows.</li>
                    </ul>
                </div>
            </div>
