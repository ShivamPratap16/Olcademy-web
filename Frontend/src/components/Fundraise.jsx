    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* Background Image */}
                <img
                    src="/src/assets/fundraise.jpg" // Ensure this image exists in your assets
                    alt="Olcademy Fundraise"
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Helping Startups Secure Funding</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Connecting startups with a network of potential investors.</li>
                        <li>Providing guidance on pitch preparation and fundraising strategies.</li>
                        <li>Offering insights into market trends and funding opportunities.</li>
                        <li>Facilitating access to funding events and investor meetings.</li>
                        <li>Supporting startups throughout the funding journey for sustained growth.</li>
                    </ul>
                </div>
            </div>
