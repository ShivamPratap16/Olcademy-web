...
const Healthcare = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Enhancing patient care through technology",
            solutionContent:
                "We implement advanced healthcare technologies to improve patient outcomes, streamline processes, and provide personalized care. Our solutions focus on integrating technology in everyday healthcare operations, making them more efficient and effective.",
        },
        {
            solutionTitle: "Data-driven decision making",
            solutionContent:
                "Utilizing predictive analytics, we help healthcare organizations make informed decisions that enhance operational efficiency and patient care. By analyzing data patterns, we enable proactive management of healthcare services.",
        },
        {
            solutionTitle: "Securing health information",
            solutionContent:
                "With our cybersecurity solutions, we protect sensitive patient information from cyber threats. We ensure that healthcare organizations comply with regulations while maintaining the highest standards of data integrity.",
        },
        {
            solutionTitle: "Transforming patient experiences",
            solutionContent:
                "We redesign patient interactions to be more engaging and informative. Through innovative platforms and services, we ensure patients have seamless access to healthcare resources, leading to improved satisfaction and health outcomes.",
        },
    ];
        ...
        <div className="w-full h-auto bg-white">
            ...
            <div className="relative h-[85vh] mt-16 image-container">
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
                    <h2 className="text-sm font-semibold text-white uppercase tracking-widest mb-2">Industries / Healthcare</h2>
                    <h1 className="text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
                        Healthcare
                    </h1>
                    <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
                        Olcademy empowers healthcare organizations to embrace innovative solutions for patient care.
                    </p>
                </div>
            </div>

            {/* New Information Section - Healthcare Innovation */}
    ...
    <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-black mb-4 leading-relaxed">
            The healthcare industry is continuously evolving, leveraging innovative technologies to enhance patient care and operational efficiency. We focus on integrating healthcare solutions that foster collaboration and streamline processes across the healthcare ecosystem.
        </p>
    </div>
</div>
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-gray-900 mt-8 bg-white rounded-lg shadow-lg">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
                    <h2 className="text-4xl mb-4 text-black">
                        Partner with us for intelligent healthcare solutions.
                    </h2>
