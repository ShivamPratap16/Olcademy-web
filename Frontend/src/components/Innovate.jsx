    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* First Image */}
                <img
                    src="/src/assets/innovate.jpg" // Replace with the actual path of the image
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Catalyzing Innovation through Technology and Strategic Partnerships</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Foster a culture of creativity and innovation.</li>
                        <li>Implement cutting-edge technologies to enhance productivity.</li>
                        <li>Collaborate with experts to solve complex challenges.</li>
                        <li>Turn ideas into actionable strategies for growth.</li>
                        <li>Gain a competitive edge through innovative solutions.</li>
                    </ul>
                </div>
            </div>
