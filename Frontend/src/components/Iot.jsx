...
const Iot = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Smart Device Integration",
            solutionContent:
                "We help businesses integrate IoT devices with existing systems to enable seamless communication and data exchange. Our solutions empower organizations to manage and monitor devices remotely, improving operational efficiency and reducing costs.",
        },
        {
            solutionTitle: "Real-Time Data Monitoring",
            solutionContent:
                "Leverage IoT sensors and platforms to collect real-time data from devices, enabling businesses to make proactive decisions. Our solutions ensure that businesses can track and analyze operations, equipment, and environment conditions in real time.",
        },
        {
            solutionTitle: "Predictive Maintenance",
            solutionContent:
                "Using IoT-enabled analytics, we offer predictive maintenance solutions that detect potential equipment failures before they happen. Our tools help businesses extend the lifespan of assets, reduce downtime, and save costs on repairs.",
        },
        {
            solutionTitle: "IoT Cloud Solutions",
            solutionContent:
                "We provide cloud-based IoT solutions that enable secure storage, processing, and analysis of data from a variety of connected devices. Our cloud platforms allow businesses to scale their IoT systems and easily integrate them with other technologies for enhanced performance.",
        },
    ];
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
        <h2 className="text-sm font-semibold text-white uppercase tracking-widest mb-2">Services / IoT Digital Solutions</h2>
        <h1 className="text-5xl lg:text-6xl font-bold text-white mb-4 leading-tight">
            IoT Digital Solutions
        </h1>
        <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
            Transform your business with cutting-edge IoT technologies.
        </p>
    </div>
</div>
...
<div className="flex flex-col items-center justify-center h-[80vh] bg-white">
    <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
            The Internet of Things (IoT) is revolutionizing industries by connecting devices, collecting real-time data, and enabling smarter decision-making. Our IoT solutions empower businesses to innovate, optimize operations, and enhance customer experiences in the digital era.
        </p>
    </div>
</div>
    ...
    <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
        <h2 className="text-4xl mb-4 text-black">
            Partner with us for IoT Digital Transformation.
        </h2>
            ...
            {solutionData.map((item, index) => (
                ...
                >
                    ...
                    <div className="ml-4">
                        ...
                        <p className="text-sm text-gray-600">{item.solutionDescription}</p> {/* Optional description */}
                    </div>
                </div>
            ))}
        </div>
    ...
    <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6 mt-8 lg:mt-0">
        <h3 className="text-sm font-bold uppercase mb-2 text-gray-500">Our IoT Solutions</h3>
