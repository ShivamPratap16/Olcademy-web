    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* First Image */}
                <img
                    src="/src/assets/launch.jpg" // Ensure this image exists in your assets
                    alt="Olcademy Launchpad"
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Empowering Startups for Success</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Comprehensive support tailored to startup needs.</li>
                        <li>Access to industry expertise and market insights.</li>
                        <li>Innovative strategies to drive growth and scalability.</li>
                        <li>Networking opportunities with investors and partners.</li>
                        <li>Robust framework for developing sustainable business models.</li>
                    </ul>
                </div>
            </div>
