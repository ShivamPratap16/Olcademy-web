...
const LifeSciences = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Accelerating Research and Development",
            solutionContent:
                "We provide cutting-edge technologies that speed up the research and development lifecycle, from concept to clinical trials.",
        },
        {
            solutionTitle: "Data-Driven Drug Discovery",
            solutionContent:
                "Our advanced data analytics solutions help in discovering new drugs by analyzing vast amounts of healthcare data and trends.",
        },
        {
            solutionTitle: "Enhanced Collaboration and Compliance",
            solutionContent:
                "We offer tools that enhance collaboration between researchers, healthcare providers, and patients, while ensuring compliance with industry regulations.",
        },
        {
            solutionTitle: "Digital Healthcare Solutions",
            solutionContent:
                "Our digital solutions improve operational efficiency, streamline patient management, and ensure better patient outcomes.",
        },
    ];
    ...
    return (
        <div className="w-full h-auto bg-white">
            ...
            <div className="relative h-[85vh] mt-16 image-container">
                <img
                    src="/src/assets/lifescience.png"
                    alt="Life Sciences"
                    className="absolute inset-0 object-cover w-full h-full"
                />
                <div className="absolute inset-0 bg-black opacity-30"></div>
                <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
                    <h2 className="text-sm font-semibold text-white uppercase tracking-widest mb-2">Industries / Life Sciences</h2>
                    ...
                    <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
                        Pioneering advancements in healthcare and life sciences to improve patient outcomes and operational efficiency.
                    </p>
                </div>
            </div>

            {/* New Information Section - Life Sciences Innovation */}
            <div className="flex flex-col items-center justify-center h-[80vh] bg-white">
                <div className="max-w-3xl text-center">
                    ...
                    <p className="text-lg text-black mb-4 leading-relaxed">
                        We harness the power of technology to revolutionize life sciences, enabling faster research, smarter healthcare solutions, and better patient care.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-gray-900 mt-8 bg-white rounded-lg shadow-lg">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
                    <h2 className="text-4xl mb-4 text-black">
                        Partner with us for innovative life sciences solutions.
                    </h2>
