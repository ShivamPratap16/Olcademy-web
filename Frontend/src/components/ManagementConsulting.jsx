...
const ManagementConsulting = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Strategic Planning",
            solutionContent:
                "We assist businesses in defining a clear strategy to achieve their long-term goals. Our consultants help identify growth opportunities, optimize resources, and align business objectives with a robust, actionable plan.",
        },
        {
            solutionTitle: "Operational Efficiency",
            solutionContent:
                "Through process optimization and best practices, we help organizations increase productivity and reduce costs. Our solutions streamline operations and drive efficiency, enabling sustainable growth and improved performance.",
        },
        {
            solutionTitle: "Digital Transformation",
            solutionContent:
                "Our digital transformation services empower companies to leverage technology for competitive advantage. From integrating new digital tools to enhancing customer experience, we guide businesses through every step of the transformation journey.",
        },
        {
            solutionTitle: "Change Management",
            solutionContent:
                "We provide structured change management solutions to help organizations adapt to new strategies, technologies, and processes. Our approach ensures minimal disruption, promoting a smooth transition and adoption by all teams.",
        },
    ];
 ...
 <div className="relative h-[85vh] mt-16 image-container">
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
        ...
        <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
            Empowering businesses to optimize strategies, enhance performance, and drive sustainable growth.
        </p>
    </div>
</div>
            ...
            <div className="flex flex-col items-center justify-center h-[80vh] bg-white">
                <div className="max-w-3xl text-center">
                    ...
                    <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                        Our management consulting services help businesses optimize strategies, streamline operations, and drive sustainable growth. From organizational transformation to performance improvement, we work with you to solve complex challenges and accelerate success.
                    </p>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-gray-900 mt-8 bg-white rounded-lg shadow-lg">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
                    <h2 className="text-4xl mb-4 text-black">
                        Partner with us for management consulting excellence.
                    </h2>
                    ...
                    <div className="space-y-4">
                        {solutionData.map((item, index) => (
                            <div
                                key={index}
                                className={`flex items-center p-4 rounded-lg border transition-all duration-300 ${selectedChallenge === index ? "bg-blue-100 border-[#15a7e7]" : "bg-gray-50 border-gray-300"}`}
                            >
                                <button
                                    className={`text-lg font-bold rounded-full w-10 h-10 flex items-center justify-center transition-all duration-300 ${selectedChallenge === index ? "bg-[#15a7e7] text-white" : "bg-gray-300 text-black"}`}
            ...
            <div className="bg-gray-800 p-8 rounded-lg mt-16 mx-10">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col">
                    ...
                    <textarea name="message" value={formData.message} onChange={handleChange} className="p-2 mb-4 rounded-md bg-gray-700 text-white focus:outline-none" rows="4" required></textarea>

                    <button type="submit" disabled={isSubmitting} className="bg-blue-600 text-white p-2 rounded-md hover:bg-blue-700 disabled:opacity-50">
