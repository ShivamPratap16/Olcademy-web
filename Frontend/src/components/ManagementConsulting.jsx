        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Transform Your Business with Olcademy</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Leverage industry insights to inform strategic decisions.</li>
                        <li>Streamline operations for greater efficiency and effectiveness.</li>
                        <li>Enhance your organizational capabilities through targeted interventions.</li>
                        <li>Utilize best practices to drive performance improvements.</li>
