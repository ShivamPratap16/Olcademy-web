    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* First Image */}
                <img
                    src="/src/assets/market.jpg" // Replace with the actual path of the image
                    alt="MarketSense Solutions"
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Transform Your Insights with MarketSense</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Leverage data-driven insights for strategic decision-making.</li>
                        <li>Analyze market trends to stay ahead of the competition.</li>
                        <li>Utilize advanced analytics tools for accurate forecasting.</li>
                        <li>Enhance your understanding of consumer behavior.</li>
                        <li>Drive innovation through comprehensive market research.</li>
                    </ul>
                </div>
            </div>
