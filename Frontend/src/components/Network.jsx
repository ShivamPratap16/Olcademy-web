        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Optimize Your Connectivity with Olcademy</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Implement robust network architectures to enhance performance and reliability.</li>
                        <li>Ensure seamless integration across all systems and devices.</li>
                        <li>Utilize advanced security protocols to safeguard your network.</li>
                        <li>Monitor and manage network traffic for optimized resource allocation.</li>
                        <li>Support remote work and collaboration with secure access solutions.</li>
                    </ul>
                </div>
            </div>
