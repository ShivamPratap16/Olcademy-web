    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* First Image */}
                <img
                    src="/src/assets/scale.jpg" // Replace with the actual path of the image
                    alt="ScaleUp Solutions"
                ...
                <div className="absolute inset-0 flex items-center justify-center z-20">
                    <h1 className="text-7xl font-bold text-black transition-all duration-300 transform hover:scale-105 hover:text-black">
                        OLCADEMY SCALEUP
                    </h1>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Solutions Designed to Help Startups Scale Their Operations Efficiently</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Optimize your business processes for maximum efficiency.</li>
                        <li>Implement scalable solutions that grow with your startup.</li>
                        <li>Access expert guidance to navigate growth challenges.</li>
                        <li>Leverage technology to automate and streamline operations.</li>
                        <li>Enhance your market presence with tailored strategies.</li>
                    </ul>
                </div>
            </div>
