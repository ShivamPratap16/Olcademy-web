...
import { BarChart2, DollarSign, Settings, ShoppingBag, ShoppingCart, TrendingUp, Users, Menu,UserPen } from "lucide-react";
...
const SIDEBAR_ITEMS = [
    ...
    { name: "Changes", icon: UserPen, color: "#F59E0B", href: "/dashboard" },
