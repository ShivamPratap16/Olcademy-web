    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* Background Image */}
                <img
                    src="/src/assets/small.jpg" // Update with your actual image path
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Unlocking Potential for Small Businesses</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Providing tailored digital solutions for growth.</li>
                        <li>Offering training programs for skill enhancement.</li>
                        <li>Creating networking opportunities to foster collaboration.</li>
                        <li>Facilitating access to funding and resources.</li>
                        <li>Encouraging innovation and adaptation in a changing market.</li>
                    </ul>
                </div>
            </div>
