    ...
    return (
        <div className="w-full h-auto">
            ...
            <div className="relative h-[70vh] mt-16 group">
                {/* Background Image */}
                <img
                    src="/src/assets/smart.jpg" // Update with your actual image path
                    alt="Smart Solutions for Every Classroom"
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Bridging Gaps in Education with Technology</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Integrating smart technology to enhance learning experiences.</li>
                        <li>Creating interactive and engaging classroom environments.</li>
                        <li>Facilitating seamless communication between educators and students.</li>
                        <li>Providing tools that support diverse learning needs.</li>
                        <li>Promoting collaboration through digital resources.</li>
                    </ul>
                </div>
            </div>
