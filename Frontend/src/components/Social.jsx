        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Empowering Communities with Olcademy</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Promote sustainable practices across all business operations.</li>
                        <li>Invest in community development initiatives and partnerships.</li>
                        <li>Support education, health, and welfare programs for local communities.</li>
                        <li>Foster a culture of volunteerism and philanthropy among employees.</li>
                        <li>Advocate for environmental responsibility and climate action.</li>
                    </ul>
                </div>
            </div>
