...
const Staffing = () => {
    ...
    const solutionData = [
        {
            solutionTitle: "Talent Acquisition",
            solutionContent:
                "We help businesses find the right talent by leveraging a strategic approach to recruitment. Our staffing solutions focus on identifying top candidates who match your company's culture and needs.",
        },
        {
            solutionTitle: "Temporary Staffing",
            solutionContent:
                "Our temporary staffing solutions provide businesses with the flexibility to scale their workforce quickly. We ensure that you have the right talent at the right time, whether for short-term projects or seasonal demands.",
        },
        {
            solutionTitle: "Permanent Staffing",
            solutionContent:
                "We offer permanent staffing solutions, helping businesses build long-term teams with the right skills and expertise. Our team ensures that candidates align with your company's mission and vision.",
        },
        {
            solutionTitle: "Executive Search",
            solutionContent:
                "Our executive search services are designed to identify and attract top-tier executives and senior leaders. We provide a tailored approach to help organizations find the right leadership talent to drive growth and innovation.",
        },
    ];
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-start z-20 px-10 md:px-20">
        ...
        <p className="text-lg lg:text-xl text-white max-w-[80%] lg:max-w-[40%] mb-6 leading-relaxed">
            Olcademy helps businesses build strong teams with the right talent through our customized staffing solutions.
        </p>
    </div>
</div>
    ...
    <div className="max-w-3xl text-center">
        ...
        <p className="text-lg text-gray-700 mb-4 leading-relaxed">
            Our staffing solutions provide businesses with the right talent to drive growth and innovation. Whether you need temporary, permanent, or executive-level professionals, we ensure the right fit for your organization's needs.
        </p>
    </div>
</div>
...
<div className="flex flex-col lg:flex-row items-start p-8 text-gray-900 mt-8 bg-white rounded-lg shadow-lg">
    <div className="flex flex-col justify-center w-full lg:w-1/2 pr-6">
        <h2 className="text-4xl mb-4 text-black">
            Partner with us for staffing solutions.
        </h2>
        <h3 className="text-sm font-bold uppercase mb-2 text-gray-500">Your Staffing Challenge</h3>
    ...
    <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6 mt-8 lg:mt-0">
        <h3 className="text-sm font-bold uppercase mb-2 text-gray-500">Our Staffing Solutions</h3>
