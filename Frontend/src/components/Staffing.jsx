        ...
        <div className="w-full h-auto">
            ...
            <div className="flex flex-col lg:flex-row items-start p-8 text-white mt-8">
                ...
                <div className="flex flex-col justify-center w-full lg:w-1/2 pl-6">
                    <h2 className="text-4xl font-bold mb-6">Build Your Team with Olcademy</h2>
                    <ul className="text-gray-300 leading-relaxed mb-4 list-disc pl-5">
                        <li>Access top talent with the skills and expertise you need.</li>
                        <li>Streamline your hiring process for faster placements.</li>
                        <li>Enhance workforce flexibility with scalable staffing solutions.</li>
                        <li>Leverage our industry knowledge to find the right fit for your organization.</li>
                        <li>Develop a competitive advantage through strategic talent acquisition.</li>
                    </ul>
                </div>
            </div>
