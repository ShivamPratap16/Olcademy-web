...
const User_Data = [
    ...
    { id: 2, name: "Ustad g", email: "john.smith@gmail.com", role: "Admin2", status: "Active" },
    { id: 3, name: "Wahab", email: "wahab.noor@gmail.com", role: "Admin2", status: "Inactive" },
    { id: 4, name: "Danish", email: "danish.joe@gmail.com", role: "Admin2", status: "Active" },
    { id: 5, name: "Usama", email: "usama.glasses@gmail.com", role: "Admin2", status: "Active" },
    { id: 6, name: "Ayesha", email: "ayesha.khan@gmail.com", role: "Admin", status: "Inactive" },
    { id: 7, name: "Hassan", email: "hassan.ali@gmail.com", role: "Admin2", status: "Active" },
    { id: 8, name: "Sarah", email: "sarah.jones@gmail.com", role: "Admin", status: "Active" },
    { id: 9, name: "Ali", email: "ali.baba@gmail.com", role: "Admin2", status: "Inactive" },
    { id: 10, name: "Fahad", email: "fahad.king@gmail.com", role: "Admin2", status: "Active" },
    { id: 11, name: "Zainab", email: "zainab.queen@gmail.com", role: "Admin2", status: "Active" },
    { id: 12, name: "Bilal", email: "bilal.smart@gmail.com", role: "Admin2", status: "Inactive" },
    { id: 13, name: "Rizwan", email: "rizwan.shah@gmail.com", role: "Admin2", status: "Active" },
    { id: 14, name: "Kiran", email: "kiran.doe@gmail.com", role: "Admin2", status: "Inactive" },
...
const UsersPageTable = () => {
    ...
    return (
        <div className="flex h-screen bg-gray-900 mt-[2.5rem]">
             <Sidebar /> 
                            ...
                            >
                                ...
                                <td className='px-6 py-4 whitespace-nowrap'>
                                    <span className={`px-4 inline-flex rounded-full text-xs bg-gray-200 leading-5 font-semibold 
                                        ...
                                        : user.role === "Admin2" ? "text-teal-600"
                                            : user.role === "Admin2" ? "text-orange-600"
                                                    : "text-gray-100"}`}>
                                        {user.role}
                                    </span>
                                </td>
